...
<html>
	...
	<title>PMAC-AU - Mantenimiento Proveedor</title>
</head>
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				...
				<table id="proveedor_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
					<thead>
						<tr>
						<th class="d-none d-sm-table-cell" style="width: 2%;"></th>
							<th class="d-none d-sm-table-cell" style="width: 40%;">Proveedor</th>
