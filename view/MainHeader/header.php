<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            <img class="hidden-md-down" src="../../public/img/diresa.svg" alt="">
            <img class="hidden-lg-up" src="../../public/img/diresa.svg" alt="">
        </a>
        ...
        <div class="site-header-content">
            <div class="site-header-content-in">
                ...
                <input type="hidden" id="user_idx" value="<?php echo $_SESSION["us_id"] ?>"><!-- ID del Usuario-->
                <input type="hidden" id="rol_idx" value="<?php echo $_SESSION["rol_id"] ?>"><!-- Rol del Usuario-->

                <div class="dropdown dropdown-typical">
                    <a href="#" class="dropdown-toggle no-arr">
                        <span class="font-icon font-icon-user"></span>
                        <span class="lblcontactonomx"><?php echo $_SESSION["us_nom"] ?> <?php echo $_SESSION["us_ap"] ?></span>
                    </a>
                </div>
